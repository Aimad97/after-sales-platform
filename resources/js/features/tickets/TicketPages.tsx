...
export function TicketFormPage() {
    ...
    const productsQuery = useQuery({ queryKey: ['catalog', 'products', 'ticket-create'], queryFn: () => listProducts({ per_page: 100, sort: 'name', direction: 'asc', active: true }) });
