...
export function createEcho(): Echo<'reverb'> {
    ...
    return new Echo<'reverb'>({
        ...
        channelAuthorization: {
            customHandler: ({ socketId, channelName }: ChannelAuthorizationRequest, callback: ChannelAuthorizationCallback) => {
                void apiClient
                    .post<ChannelAuthorizationResponse>('/broadcasting/auth', {
                        socket_id: socketId,
